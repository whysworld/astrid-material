...
const ASTRID_BACKGROUND_DEFAULT_COLOR = '#242735';
const ASTRID_HEADER_BORDER_COLOR = '#242735';
const ASTRID_BACKGROUND_PAPER_COLOR = '#35384b';
const ASTRID_TABLE_HEADER_BK_COLOR = 'transparent';
const ASTRID_TABLE_TR_HOVER_COLOR = '#078482';
const ASTRID_LISTITEM_LIST_SELECTED_COLOR = '#005bb8';
const ASTRID_LISTITEM_LIST_HOVER_COLOR = '#004285';
const ASTRID_HEADER_TITLE_COLOR = '#00a09e';

const ASTRID_NAVIGATION_BACKGROUND_COLOR = '#172a46';

export const ASTRID_HEADER_BACKGROUND_COLOR = '#35384b';
...
export const AstridDarkTheme: AstridTheme = {
  ...baseDarkTheme,
  header: {
